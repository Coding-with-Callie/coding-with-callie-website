...
import { Profile, Speaker } from "../../Pages/GuestSpeakers";
import { Box, Center, Divider, Flex, IconButton, useMediaQuery } from "@chakra-ui/react";
...
const UpcomingCarousel = ({speakers} : Props) => {
    ...
    return (
        <Section 
            screenSizeParameter={isLargerThan1200} 
