  ...
  return (
    <>
      ...
      <Text color="#45446A" mb={4}>
        ...
        the development ticket. If they do not respond to the job offer, Callie
        will either repost the job or select another applicant.
      </Text>
      <Text color="#45446A" mb={4}>
        Upon acceptance of a development ticket, you will be added to the
        relevant Github repository for the time you are working on that ticket.
      </Text>
      ...
      <Text color="#45446A" mb={4}>
        ...
        criteria for the task, a date on which the task must be completed, and a
        payment amount to be paid when your code is merged into the main branch
        of the relevant Github repository.
      </Text>
      <Text color="#45446A" mb={4}>
        A task is complete when you have submitted a pull request to the main
        branch with a description of the work you have completed and proof that
        your code meets all of the acceptance criteria in the ticket in the form
        of unit tests, screenshots, gifs, etc.
      </Text>
      <Text color="#45446A" mb={4}>
      ...
      <Text color="#45446A" mb={4}>
        ...
        request a new code review. If further refactoring is needed, it is up to
        the discretion of Coding with Callie mentor whether or not to request
        changes or decline the pull request.
      </Text>
      <Text color="#45446A" mb={4}>
        You can be removed at any time from the Coding with Callie jobs list due
        to unsatisfactory work or actions that may negatively impact the
