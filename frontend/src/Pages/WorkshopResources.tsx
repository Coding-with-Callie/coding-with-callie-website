  ...
  if (id && parseInt(id) === 2) {
      ...
      <>
        <Section screenSizeParameter={false} alignItemsCenter={false}>
          ...
          <Text color="#45446A" mb={4}>
            ...
            my features. There are 10 assignments and corresponding solution
            pages with hours worth of step-by-step videos.
          </Text>
          <Text color="#45446A" mb={4}>
          ...
          <Text color="#45446A" mb={4}>
            Each task has a summary of its requirements, the deliverable you
            must submit, and helpful links to kick off your work. Try to give
            the assignment your best shot before viewing the solution videos,
            but know that they're there if you get too stuck.
          </Text>
          <Text color="#45446A" mb={4}>
            Submitting your deliverable will unlock options to see and review
            other participants' submissions. Please note that an assignment is
            not "complete" until you submit your deliverable and review two
            other participant submissions. If you want a more detailed code
            review, consider joining our weekly meet-ups!
          </Text>
        </Section>
        <Box>
    ...
    return (
      <>
        <Section screenSizeParameter={false} alignItemsCenter={false}>
          <BodyHeading textAlignCenter={true}>
            This workshop isn't planned yet! There are no resources 🫣
          </BodyHeading>
        </Section>
      </>
    );
