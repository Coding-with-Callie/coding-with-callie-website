...
export class EditReview1713379430317 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "review" DROP CONSTRAINT "FK_15097e0bca7706dd7e272ca181a"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "workshop" ADD "sessions" jsonb NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "workshop" ADD "stripeId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "workshop" ADD "available" boolean NOT NULL DEFAULT false`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "review" ADD "session" integer NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "review" ADD CONSTRAINT "FK_15097e0bca7706dd7e272ca181a" FOREIGN KEY ("workshopId") REFERENCES "workshop"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
