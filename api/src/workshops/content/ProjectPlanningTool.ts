...
export const projectPlanningTool: Workshop = {
  ...
  photo: 'https://coding-with-callie.s3.amazonaws.com/fullstack.png',
  details: [
    'Create a tool for product managers and developers to use to plan their projects and track their progress as they build them. To start off, we will set up user authentication so that users can create accounts, manage their account details, reset their passwords, and even delete their accounts.',
    'Then, we’ll move onto the application’s main functionality. First, you’ll code the create project workflow so users can create projects, features within those projects, user stories within those features, and developer tasks within those user stories. Creating the projects is just the beginning, though! You’ll need to make sure users can edit all of their details and delete their projects, features, user stories, and tasks too.',
    'This workshop is self-paced and has 10 assignments. Each assignment has an assignment video, a summary of my expectations for your work, some helpful links, and a deliverable that you must submit. Complete the assignments as you have time and use my solution videos if you get stuck! After you complete an assignment, the other participants’ submissions will become unlocked. In order to fully “complete” an assignment, you must review at least two other participants’ deliverables.',
    'If you complete all 10 assignments and corresponding peer assignment reviews, I will send you a certificate of completion and post a recommendation for you on your LinkedIn.',
  ],
  objectives: [
    'Plan a project and split dev work into doable tasks',
    'Create an API that communicates with a UI and database',
    'Style your UI with a components library',
    'Set up user account creation/maintenance securely',
    'Complete manual end-to-end testing',
    'Add automated spec tests to your backend service',
  ],
  techStack: [
    'TypeScript',
    'React',
  ...
  price: 250,
  available: true,
  stripeId: 'price_1P1H3hGPYyWkM7JWPLsO6AFW',
  sessions: [
    {
    ...
    },
    {
      ...
      solutionLinks: [
        ...
        },
        {
          ...
          label:
            'UI: Added Components Necessary to Edit User Story Description',
          type: 'video',
        },
        {
    ...
    },
    {
      ...
      solutionLinks: [
        ...
        },
        {
          ...
          label:
            'UI/Bug: Fixed Accordion Automatically Opening on Delete Click',
          type: 'video',
        },
        {
