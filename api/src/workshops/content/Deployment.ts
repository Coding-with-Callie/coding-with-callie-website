...
export const deployment: Workshop = {
  ...
  details: [
    ...
    "Then, it's time to help your cohort-mates gain some visibility! Check out their LinkedIn posts (you'll have a list of post links) and comment on at least 2 of them.",
    "If you fully complete the workshop (10 deliberables, 10+ LinkedIn posts, 2 peer reviews per task) by the workshop deadline (August 1, 2024), I'll send you a certificate of completion, post a recommendation for you on your LinkedIn, and give you an opportunity to make money working on the Coding with Callie website.",
