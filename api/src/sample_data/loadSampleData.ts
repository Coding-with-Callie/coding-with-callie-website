    ...
    try {
        ...
        for (let i = 0; i < 2; i++) {
            const sampleUser = await usersRepository.save({
                ...
                photo:  'https://coding-with-callie.com/static/media/sloth.b29ac2f36bd49aeb8a17.png',
                review: [],
                projects: []
            });
            ...
            const sampleSpeaker = await speakerRepository.save({
                ...
                time: '8PM EST',
                sessionText: [
                    `Sample session text 1`, 
                    'Sample session text 2'
                ],
                bioText: [`Sample bio text 1`, 'Sample bio text 2'],
                websiteUrl: `http://`,
                photoUrl: 'https://coding-with-callie.com/static/media/sloth.b29ac2f36bd49aeb8a17.png',
